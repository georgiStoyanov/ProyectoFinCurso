...
<body id="top">
	...
	<div style="background: white; width: 80%; margin: auto;">
			<div class="indicador_pasos"><div class="indicador_paso" style="background: rgb(242, 140, 130); padding: 0.5em; border-radius: 0.5em; width: 28%; color: whitesmoke;" ;="">Información obra</div><div class="indicador_paso" style="background: rgb(242, 140, 130); padding: 0.5em; border-radius: 0.5em; width: 28%; color: whitesmoke;" ;="">Precios orientativos</div><div class="indicador_paso" style="background: rgb(232, 76, 61); padding: 0.5em; border-radius: 0.5em; width: 28%; color: whitesmoke;" ;="">Informacion contacto</div></div>
			<form action="${pageContext.request.contextPath}/GrabaContacto" method="post">
			<fieldset class="">
				<h2>Informacion contacto</h2>
					<div class="row">
						<div class="col-lg-6 col-md-6"><label>Persona de contacto:</label>
							<input class="btmspace-15" style="width:100%" type="text" name="NombreContacto" required placeholder="Su nombre">
						</div> 
						<div class="col-lg-6 col-md-6">
							<label>Correo electrónico:</label> <input style="width:100%" class="btmspace-15" type="email" name="emailContacto" required placeholder="Email">
						</div>
					<div class="col-lg-6 col-md-6">
							<label>Dirección de la obra:</label> <input style="width:100%" class="btmspace-15" type="text" name="direccionObra" required placeholder="La completa direccion del edifico donde se va a realizar la obra.">
					</div>
					<div class="col-lg-6 col-md-6">
							<label>Teléfono de contacto:</label> <input style="width:100%" class="btmspace-15" type="tel" name="telefono" required placeholder="Teléfono de contacto 1">
					</div>
						<div class="col-lg-12 col-md-12">
							<label>Descripcion:</label>
							<textarea class="btmspace-15" style="width:100%" name="descripcion" required placeholder="Aqui puede describir la situacion de la obra o simplemente añadir información adicional que considera importante."></textarea>
						</div>
					</div>
			</fieldset>
